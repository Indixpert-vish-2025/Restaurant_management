...
class AdminManager:
    base_dir = os.path.dirname(os.path.dirname(__file__))  # Goes from Authentication -> SRC
    admin_file = os.path.join(base_dir, 'Database', 'admins.json')
...
# class AdminManager:
#     admin_file = 'Database/admins.json'
#     staff_file = 'Database/staff_data.json'
...
#         print("Available Staff Members:")
#         for idx, staff in enumerate(staff_data):
#             print(f"{idx+1}. {staff['name']} (ID: {staff['id']})")
